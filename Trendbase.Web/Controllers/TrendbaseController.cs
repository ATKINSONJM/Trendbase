...
namespace Trendbase.Web.Controllers
{
    public class TrendbaseController : ApiController
    {
        public HttpResponseMessage Get()
        {
            ...
            {
                string query =
                    "SELECT top 100000 ticketId, age, routeId, dateOfPurchase, railcardUsed, price, dateOfTravel FROM[dbo].[ticket] JOIN[dbo].[customer] ON [dbo].[ticket].[customerId] = [dbo].[customer].id WHERE dateOfPurchase > DATEADD(day, -30, GETDATE())";
